...
You can use the [editor on GitHub](https://github.com/jenniferhay/ororeo/edit/gh-pages/index.md) to maintain and preview the content for your website in Markdown files.
...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/jenniferhay/ororeo/settings). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
